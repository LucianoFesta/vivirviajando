...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 30-01-2023 a las 14:31:26
...
INSERT INTO `compras` (`id`, `id_usuario`, `totalCompra`, `formaPago`) VALUES
(38, '293c69d0-1898-4015-a530-da5456e978e3', '283000.00', 'creditCard'),
(39, '293c69d0-1898-4015-a530-da5456e978e3', '248000.00', 'transfer'),
(40, '7f3eebfc-8b06-4ed6-9ed7-4815776d8d3f', '183500.00', 'transfer'),
(41, '293c69d0-1898-4015-a530-da5456e978e3', '201000.00', 'creditCard');
...
INSERT INTO `itemscompra` (`id`, `id_compra`, `id_producto`, `nombre`, `servicio`, `precio`, `cantidad`) VALUES
(25, 38, 4, 'Curazao', 'Vuelo desde Rosario', '260000.00', 1),
(26, 38, 8, 'Hotel NYX Cancún', 'Hotel en Cancún', '23000.00', 1),
(27, 39, 9, 'Seagarden Beach Resort', 'Hotel en Jamaica', '18000.00', 1),
(28, 39, 10, 'Dunns River Falls', 'Actividad en Jamaica', '15000.00', 1),
(29, 39, 2, 'Tailandia', 'Vuelo desde Baires', '215000.00', 1),
(30, 40, 12, 'Buzios - Brasil', 'Paquete 7 Noches a Buzios', '175000.00', 1),
(31, 40, 7, 'Snuba - Isla San Andrés', 'Actividad en San Andrés', '5000.00', 1),
(32, 40, 11, 'Isla Johnny Kay', 'Actividad en San Andrés', '3500.00', 1),
(33, 41, 15, 'Hol Box', 'Excursion en Cancún', '15000.00', 1),
(34, 41, 17, 'Cancún', 'Vuelos desde Buenos Aires', '186000.00', 1);
...
(15, 'Hol Box', 4, '/images/products/1674746268262_product.jpg', 'Actividad hacia HolBox', 'Excursion en Cancún', '15000', 3, 'Increíble e imperdible excursión en Cancún. Conocé esta espectacular isla en medio del caribe Mexicano. Fecha 15/06/2023.'),
(17, 'Cancún', 1, '/images/products/1674763774178_product.png', ' Conocé Cancún y la Riviera Maya ', 'Vuelos desde Buenos Aires', '186000', 2, 'Volá a este paraíso con SKY AIRLINES desde la ciudad de Buenos Aires. Fecha del vuelo, 15/05/2023 al 26/05/2023. Primer tramo, saliendo el 15/05/2023 a las 20:30Hs, escala de 2Hs en la ciudad de Santiago de Chile. Segundo tramos, 15/05/2023 a las 22:35Hs hacia la ciudad de Lima, llegando a las 05:00Hs del 16/05/2023 para partir desde allí a las 10:30Hs hacia Cancún. Hora de llegada 13:30Hs del 16/05/2023.');
...
--
-- Volcado de datos para la tabla `productoseliminados`
--

INSERT INTO `productoseliminados` (`id`, `nombre`, `id_categoria`, `imagen`, `info`, `servicio`, `precio`, `id_mediosPagos`, `descripcion`) VALUES
(16, 'Caribe', 1, '/images/products/1674747068683_product.jpg', 'Volá al caribe mexicano', 'vuelo desde neuquen', '350000', 6, 'volá a Cancún con Latam.');
...
('293c69d0-1898-4015-a530-da5456e978e3', 'Lucas Manuel', 'Festa', 2, 1, '1993-06-05', 37491218, 'Marconi 950', 'Pichi Huinca', 'La Pampa', '/images/users/1673016150943_user.JPG', 'lucasfesta@hotmail.com', '$2a$10$CG1zcBasvxcDy0NSWo2WHeGwgS3YztHfT9P7ZAj9QKI3EJQGT0RWC', '$2a$10$33Rz4EaVf4RiPTS/BEmw6OPmSaL9Ix3sNyg/fvajrkxI6GDhYTvvS', 'on'),
('7f3eebfc-8b06-4ed6-9ed7-4815776d8d3f', 'Marcela', 'Viano', 2, 2, '1958-12-12', 21548698, 'San Martín 852', 'Famatina', 'La Rioja', '/images/users/1674134244711_user.png', 'marcelaviano@hotmail.com', '$2a$10$FLI7z5QAnsAQw2KnZ1SfSOwfbLRodQ.x0G8gn0X/2T7iystDA3nxS', '$2a$10$CH.NKs3z71R1gU9OjVx.Vu.uJDoF7NYVISqHMNEu8qTWLDPSxQ612', 'on'),
('ac1487bb-4388-4f8b-8abf-497238a81ec5', 'Luciano Ezequiel', 'Festa', 1, 1, '1992-01-24', 36365939, 'Marconi 843', 'Santa Fe', 'Santa Fe', '/images/users/1673266208461_user.JPG', 'lucianofesta@hotmail.com', '$2a$10$yPhywSW8HxCUNRRlies0p.BKmLRv49OffEyBRQRVzOctXhtS52lpW', '$2a$10$51EcjcFjCdAzqK3YryTXkudWXwrSi7k7R9UpshV4cMp.XKesZxC3K', 'on');
